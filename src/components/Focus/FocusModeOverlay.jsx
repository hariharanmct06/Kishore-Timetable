...
export function FocusModeOverlay() {
  ...
  const remainingSeconds = activeFocusSlot?.remainingSeconds || 7200;
    ...
    <div className="fixed inset-0 z-50 bg-slate-950 text-white flex flex-col justify-between p-6 sm:p-12 overflow-hidden select-none animate-fadeIn">
      ...
      <div className="flex items-center justify-between z-10">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-[11px] font-black tracking-widest text-slate-400 uppercase">FOCUS MODE</span>
        </div>
