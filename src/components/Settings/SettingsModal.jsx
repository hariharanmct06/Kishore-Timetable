      ...
      <div className="bg-slate-900 border border-slate-800 p-5 sm:p-8 rounded-3xl max-w-lg w-full shadow-2xl relative space-y-5 my-auto">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Kishore's study preferences and alerts</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSave} className="space-y-4 text-xs">
          ...
          <div className="space-y-2.5 pt-2 border-t border-slate-800">
            ...
            <div className="space-y-2">
              {[
                { key: 'notificationsEnabled', label: '🔔 Desktop / Mobile Notifications' },
          ...
          <div className="flex justify-end space-x-2 pt-2 border-t border-slate-800">
            ...
            <button
              type="submit"
              className="px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold shadow-lg min-h-[44px]"
            >
              Save Settings
            </button>
          </div>
